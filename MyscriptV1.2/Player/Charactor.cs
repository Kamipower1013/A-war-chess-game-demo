...
{   public string Chara_name
   ...
   [SerializeField] private int _coin;
    ...
    public int buff_Attackvalue;
    public int buff_DefenceValue;
    public int buff_dodge;
    public int buff_PathStep;
    ...
    public virtual void normal_attack(PlayerCharactor other)
    {
        ...
        if ((base_attack +buff_Attackvalue)- (other.current_defence_withbag+other.buff_DefenceValue) > 0)
        {
            int damage = base_attack+buff_Attackvalue - (other.current_defence_withbag-other.buff_Attackvalue);
            other.HP = other.HP - damage;
        }
    }
    ...
    public virtual void return_Defence()
    {
