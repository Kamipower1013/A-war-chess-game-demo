...
public class Player_panelManager : MonoBehaviour
{
    ...
    public void get_origin_playerData()
    {
        ...
        PlayerCharactorScript.current_attack_withbag = final_attack;
        PlayerCharactorScript.current_defence_withbag = final_Defence;
        PlayerCharactorScript.current_dodge = final_dodge;
        PlayerCharactorScript.current_magic_attack_withbag = final_magic_attack;
    }
    ...
    public void reflash_PlayerPanelData()
    {
        ...
        final_attack_Text.text = PlayerCharactorScript.current_attack_withbag.ToString();
        final_dfence_Text.text = PlayerCharactorScript.current_defence_withbag.ToString();
        final_dodge_Text.text = PlayerCharactorScript.current_dodge.ToString();
        final_magic_attack_Text.text = PlayerCharactorScript.current_magic_attack_withbag.ToString();
